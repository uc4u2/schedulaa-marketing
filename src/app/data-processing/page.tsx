...
export const metadata: Metadata = {
  ...
  description: 'Overview of Schedulaa data processing terms, security controls, and anti-fraud processing scope.',
};
    ...
    <main className="section-padding-x pb-24 pt-20">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mt-6 text-secondary/80 dark:text-accent/75">
          ...
          security obligations, fraud-prevention controls, and support boundaries.
        </p>
        <p className="mt-4 text-secondary/80 dark:text-accent/75">
          Schedulaa may process account, billing, and technical event data to detect and prevent fraudulent transactions,
          investigate disputes, and satisfy regulatory or processor requirements.
        </p>
        <p className="mt-4 text-secondary/80 dark:text-accent/75">
          Enterprise legal teams can request contract-specific DPA language during procurement and onboarding.
        </p>
