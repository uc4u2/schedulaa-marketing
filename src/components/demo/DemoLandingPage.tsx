      ...
      <div className="main-container space-y-10">
          ...
          <div className="mx-auto mt-6 max-w-[760px] rounded-[28px] border border-stroke-2 bg-white/90 p-4 shadow-md backdrop-blur dark:border-stroke-7 dark:bg-background-8/90">
            <div className="flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
              <div className="text-left">
                <p className="text-heading-6">{copy.mobileApps || 'Get the mobile app'}</p>
                <p className="mt-1 max-w-[460px] text-tagline-2 text-secondary/70 dark:text-accent/70">
                  {copy.mobileAppsBody || 'Install the signed Android build now. iPhone delivery will follow through the iOS rollout.'}
                </p>
              </div>
              <div className="flex flex-col gap-3 sm:flex-row">
                ...
                >
                  ...
                  <span className="block">
                    ...
                    <span className="block text-base font-semibold text-secondary dark:text-white">{copy.downloadApk || 'Download Android APK'}</span>
                  </span>
                </a>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-5">
          ...
          <article className="rounded-3xl border border-stroke-2 bg-white p-6 dark:border-stroke-7 dark:bg-background-8 lg:col-span-3">
            ...
            <div className="mt-6 rounded-[24px] border border-stroke-2 bg-background-12/50 px-4 py-4 dark:border-stroke-7 dark:bg-background-7/70">
              <p className="mb-2 font-semibold">Install the Android app directly</p>
              <p className="mb-4 text-tagline-2">Download the latest signed Schedulaa Android APK directly from our public Cloudflare R2 asset host.</p>
              <div className="flex flex-col gap-3 sm:flex-row">
                <a
                  href={ANDROID_APK_URL}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex min-w-[220px] items-center gap-3 rounded-[18px] border border-stroke-2 bg-white px-4 py-3 text-left transition-all duration-300 hover:-translate-y-0.5 hover:border-secondary hover:shadow-lg dark:border-stroke-7 dark:bg-background-8"
                >
