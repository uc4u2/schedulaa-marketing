...
> = {
  en: {
    ...
    body:
      'Schedulaa gives service managers one place to track scheduled hours, overtime risk, open coverage, approved time, and staffing pressure without waiting for spreadsheets or end-of-week rollups.',
    primaryCta: 'Book a demo',
    ...
    bullets: [
      ...
      'Keep approved-hour totals available as a back-office handoff for payroll or accounting when needed.',
    ],
  },
  fa: {
    badge: 'ديد هزينه نيروي کار',
    title: 'تيم خود را برنامه‌ريزي کنيد و فشار نيروي کار را قبل از شلوغ شدن هفته ببينيد.',
    body:
      'Schedulaa به مديران خدمات يک نماي واحد مي‌دهد تا ساعات برنامه‌ريزي‌شده، ريسک اضافه‌کاري، شيفت‌هاي خالي و فشار تامين نيرو را بدون انتظار براي فايل‌هاي اکسل يا جمع‌بندي پايان هفته ببينند.',
    primaryCta: 'رزرو دمو',
    secondaryCta: 'مشاهده قيمت',
    videoTitle: 'يک پلتفرم. يک منبع حقيقت',
    bullets: [
      'ديد امروز تيم: ساعات برنامه‌ريزي‌شده، شيفت‌هاي خالي و پوشش خدمات را يکجا ببينيد.',
      'ريسك اضافه‌کاري: کارکناني را که به اضافه‌کاري نزديک مي‌شوند زودتر شناسايي کنيد.',
      'ساعات تاييدشده و استثناها: ساعات، مرخصي و تغييرات را در يک نما مرور کنيد.',
  ...
  ru: {
    ...
    title: 'Планируйте команду и заранее замечайте нагрузку на расписание до того, как неделя станет хаотичной.',
    body:
      'Schedulaa дает менеджерам сервисных компаний единое место для контроля запланированных часов, риска переработок, открытых смен и нагрузки на персонал без таблиц и ручных сводок в конце недели.',
    primaryCta: 'Записаться на демо',
    secondaryCta: 'Смотреть цены',
    videoTitle: 'Одна платформа. Один источник правды',
    bullets: [
      'Картина по команде сегодня: запланированные часы, открытые окна и покрытие услуг в одном месте.',
      'Риск переработок: замечайте сотрудников, приближающихся к overtime, заранее.',
      'Подтвержденные часы и исключения: проверяйте часы, отпуска и изменения в одном месте.',
  ...
  zh: {
    badge: '人工成本可视化',
    title: '安排团队班次，并在一周变得混乱前看到排班压力。',
    body:
      'Schedulaa 为服务团队管理者提供一个统一视图，用来跟踪排班时数、加班风险、空缺班次和人员压力，无需再等待表格或周末汇总。',
    primaryCta: '预约演示',
    secondaryCta: '查看价格',
    videoTitle: '一个平台。一个真实来源',
    bullets: [
      '今日团队视图：在一个地方查看排班时数、空缺和服务覆盖。',
      '加班风险：提前识别接近加班阈值的员工。',
      '已批准工时与例外：在一个界面查看工时、休假和变更。',
  ...
  es: {
    ...
    title: 'Programa a tu equipo y detecta la presion operativa antes de que la semana se complique.',
    body:
      'Schedulaa ofrece a los managers de servicio un solo lugar para seguir horas programadas, riesgo de horas extra, huecos de cobertura y presion de dotacion sin esperar hojas de calculo o cierres semanales.',
  ...
  fr: {
    ...
    title: "Planifiez votre equipe et voyez la pression sur le planning avant que la semaine ne se complique.",
    body:
      "Schedulaa donne aux responsables de service un seul espace pour suivre les heures planifiees, le risque d'heures supplementaires, les trous de couverture et la pression de staffing sans attendre des feuilles de calcul ni des bilans de fin de semaine.",
  ...
  de: {
    ...
    title: 'Plane dein Team und erkenne Personaldruck, bevor die Woche unruhig wird.',
    body:
      'Schedulaa gibt Service-Managern einen zentralen Ort, um geplante Stunden, Ueberstundenrisiko, offene Abdeckung und Staffing-Druck ohne Tabellen oder Wochenend-Rollups zu verfolgen.',
  ...
  ar: {
    ...
    title: 'جدول فريقك واعرف ضغط الجدولة قبل أن يصبح الاسبوع فوضويا.',
    body:
      'يوفر Schedulaa لمديري الخدمات مكانا واحدا لمتابعة الساعات المجدولة ومخاطر العمل الاضافي والفجوات في التغطية وضغط التوظيف دون انتظار الجداول او تجميعات نهاية الاسبوع.',
  ...
  pt: {
    ...
    title: 'Planeje sua equipe e veja a pressao operacional antes que a semana fique caotica.',
    body:
      'A Schedulaa da aos gestores de servicos um unico lugar para acompanhar horas programadas, risco de horas extras, lacunas de cobertura e pressao de equipe sem depender de planilhas ou fechamentos manuais.',
            ...
            <div className="relative z-10 grid gap-8 lg:grid-cols-[1.05fr_1fr] lg:items-start">
              ...
              <div className="grid gap-3 lg:pt-1">
                {laborCopy.bullets.map((item, index) => (
                  <div
                    key={item}
                    className="group/item relative overflow-hidden rounded-2xl border border-white/12 bg-black/18 px-4 py-3 text-white shadow-[0_10px_24px_rgba(3,8,20,0.12)] backdrop-blur-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-white/22 hover:bg-white/[0.08] hover:shadow-[0_18px_42px_rgba(8,20,45,0.2)]"
                  >
